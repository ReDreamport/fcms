...
class EntityServiceMongo
    constructor: (@app)->

    gCreate: (entityMeta, instance)->
    ...
    gUpdateManyByCriteria: (entityMeta, criteria, instance)->
        update = objectToMongoUpdate instance
    ...
    gUpdateOneByCriteria: (entityMeta, criteria, instance)->
        update = objectToMongoUpdate instance
        return 0 unless update
    ...
    gUpdateByIdVersion: (entityMeta, _id, _version, instance)->
        instance._version = _version
        yield from @gUpdateOneByCriteria entityMeta, {__type: 'simple', _id, _version}, instance

    gRemoveMany: (entityMeta, ids)->
    ...
    gFindOneByCriteria: (entityMeta, criteria, {repo, includedFields})->
    ...
    # sort 为 mongo 原生格式
    gList: ({entityMeta, criteria, sort, repo, includedFields, pageNo, pageSize, withoutTotal})->
        collectionName = Meta.getCollectionName entityMeta, repo
